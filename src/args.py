...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--macaw_params', type=str, default='config/alg/standard.json')
    ...
    parser.add_argument('--log_dir', type=str, default='40_tasks_log')
    ...
    parser.add_argument('--adapt_context_only', action='store_true')
    parser.add_argument('--n_adaptation_layers', type=int, default=1)
